...
3. Now from each directory run the following (NOTE: if you run docker-compose up you will need to have an existing network in docker called xlayerapi - docker network create -d bridge xlayerapi):
